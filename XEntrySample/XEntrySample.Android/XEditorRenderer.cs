...
[assembly: ExportRenderer(typeof(XEditor), typeof(XEntrySample.Droid.Renderers.XEditorRenderer))]
namespace XEntrySample.Droid.Renderers
{
    public class XEditorRenderer : EditorRenderer
    {
        ...
        protected override void OnElementPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            if (sender is XEditor customEntry) {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<Editor> e)
        {
            ...
            if (e.NewElement is XEditor customEntry) {
        ...
        void SetXHighlightColor(in XEditor customEntry)
        {
            Control.SetHighlightColor(customEntry.XHighlightColor.ToAndroid());
        }

        void SetXHandleColor(in XEditor customEntry)
        {
        ...
        void SetBackground(in XEditor customEntry)
        {
        ...
        void SetXPadding(in XEditor customEntry)
        {
            if (customEntry == null) return;
